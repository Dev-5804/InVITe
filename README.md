...
Our event management system has two main components:

<ul>
  <li><strong>Students/Attendees:</strong> Anyone can view and register for events directly without creating an account. Simply browse events and fill in your details to register.</li>
